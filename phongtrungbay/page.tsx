...
export default function PhongTrungBay() {
    ...
    return (
        ...
        >
            {/* Compact Header - Style NghiemArt */}
            <div className="flex-none z-30 w-full h-[44px] bg-[#080808] border-b border-[#C69C6D]/30 flex items-center px-3 justify-between shadow-lg">
                <div className="flex items-center gap-2">
                    <div className="bg-[#C69C6D] text-black px-4 py-1.5 rounded-l-lg rounded-r-2xl transform skew-x-[-10deg] shadow-[0_0_15px_rgba(198,156,109,0.5)] border-r-4 border-white/20">
                        <div className="flex items-center gap-2 skew-x-[10deg]">
                            <Award size={16}/>
                            <h1 className="text-[11px] font-black uppercase tracking-[0.15em] whitespace-nowrap">PHÒNG TRƯNG BÀY</h1>
                        </div>
                    </div>
                </div>
